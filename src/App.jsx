    ...
    <div>
      ...
      <nav className="navbar">
        <div className="container navbar-inner">
          ...
          <span className="badge-tag">
            <CheckCircle2 size={16} /> 100% Gratis • Direct Download
          </span>
        </div>
      </nav>
      ...
      <section className="hero">
        ...
        <div className="container hero-content">
          <div className="official-badge-header">
            <Award size={18} color="#7A0016" />
            <span style={{ fontSize: '13px', fontWeight: 700, color: '#7A0016' }}>
          ...
          <div className="hero-pill">
            <Sparkles size={16} /> Kas Digital Praktis Tanpa Ribet
          </div>
          ...
          <div className="cta-wrapper">
            ...
            <div className="download-info-row">
              <div className="download-info-item">
                <CheckCircle2 size={16} color="#059669" /> File APK Resmi (~52.2 MB)
              </div>
              <div>•</div>
              <div className="download-info-item">
                <CheckCircle2 size={16} color="#059669" /> Android 6.0 ke Atas
              </div>
              <div>•</div>
              <div className="download-info-item">
                <CheckCircle2 size={16} color="#059669" /> Versi 1.0.0 Terbaru
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="sandbox-card">
          <div className="sandbox-header">
            <div className="sandbox-title-box">
              ...
              <div>
                <h3 style={{ fontSize: '18px', fontWeight: 800, color: '#7A0016' }}>Simulator Fitur "Ketik Cepat"</h3>
                <p style={{ fontSize: '13px', color: '#64748B' }}>Uji coba langsung bagaimana kalimat transaksi otomatis terdeteksi</p>
              </div>
            </div>

            <span style={{ fontSize: '12px', fontWeight: 700, background: '#F1F5F9', padding: '6px 12px', borderRadius: '20px' }}>
              💡 Cobalah Ketik / Klik Contoh
            </span>
          </div>
          ...
          {parsedDemo && (
            <div className={`result-badge-container ${parsedDemo.isExpense ? 'expense' : 'income'}`}>
              <div className="result-icon-circle">
                {parsedDemo.isExpense ? <ArrowDownRight size={26} /> : <ArrowUpRight size={26} />}
              </div>
              <div>
                <div style={{ fontWeight: 800, fontSize: '15px' }}>
                  Terdeteksi Otomatis: {parsedDemo.type}
                </div>
                <div style={{ fontSize: '14px', fontWeight: 600, marginTop: '2px', opacity: 0.9 }}>
                  "{parsedDemo.text}"
                </div>
              </div>
            </div>
      ...
      <section className="container">
        <div className="section-header">
          ...
          <h2 className="section-main-title">Kenapa Menggunakan CatatKas UMKM?</h2>
        ...
        <div className="features-grid">
          <div className="card-feature">
            <div className="feature-icon-box"><Zap size={28} /></div>
          ...
          <div className="card-feature">
            <div className="feature-icon-box"><Wallet size={28} /></div>
          ...
          <div className="card-feature">
            <div className="feature-icon-box"><FileText size={28} /></div>
          ...
          <div className="card-feature">
            <div className="feature-icon-box"><ShieldCheck size={28} /></div>
        ...
        <div className="steps-card-container">
          <div className="section-header" style={{ marginBottom: '0', textAlign: 'left' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '6px' }}>
              ...
              <h2 className="section-main-title" style={{ fontSize: '24px' }}>Panduan Memasang Aplikasi (APK)</h2>
            </div>
      ...
      <section className="container">
        <div className="section-header">
          ...
          <h2 className="section-main-title">Pertanyaan yang Sering Diajukan</h2>
        </div>

        <div className="faq-container">
          <div className="faq-item">
            <div className="faq-question">
              <HelpCircle size={18} /> Apakah aplikasi ini memerlukan jaringan internet?
            </div>
          ...
          <div className="faq-item">
            <div className="faq-question">
              <HelpCircle size={18} /> Apakah perlu mendaftar atau memasukkan email?
            </div>
            <div className="faq-answer">
          ...
          <div className="faq-item">
            <div className="faq-question">
              <HelpCircle size={18} /> Dimana data keuangan saya disimpan?
            </div>
            <div className="faq-answer">
      ...
      <footer className="footer">
        <div className="container">
          <p>© 2026 CatatKas UMKM • Dikembangkan untuk Kemajuan UMKM Desa Manggihan</p>
